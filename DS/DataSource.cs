...
namespace DS
{
    public static class DataSource
    {
        ...
        public static void InitAllLists()
        {
            ...
            {
                new BusLineStation{Active=true,BusStationKey=857321,NumberStationInLine=1},
                new BusLineStation{Active=true,BusStationKey=876015,NumberStationInLine=2},
                new BusLineStation{Active=true,BusStationKey=388523,NumberStationInLine=3},
                new BusLineStation{Active=true,BusStationKey=873702,NumberStationInLine=4},
                new BusLineStation{Active=true,BusStationKey=874104,NumberStationInLine=5},
                new BusLineStation{Active=true,BusStationKey=873401,NumberStationInLine=6},
                new BusLineStation{Active=true,BusStationKey=388614,NumberStationInLine=7},
                new BusLineStation{Active=true,BusStationKey=388624,NumberStationInLine=8},
                new BusLineStation{Active=true,BusStationKey=388634,NumberStationInLine=9},
                new BusLineStation{Active=true,BusStationKey=875612,NumberStationInLine=10}
