...
namespace dotNet5781_02_3747_8971
{
    ...
    class SingleBusLine : BusLineStation, IComparable
    {
        ...
        /// </summary>
        /// <returns></returns>
        public decimal DistanceTwoStations()=> DistanceBetween(UserInput().BusStop.LANDMARCK.Longitude, UserInput().BusStop.LANDMARCK.Latitude, UserInput().BusStop.LANDMARCK.Longitude, UserInput().BusStop.LANDMARCK.Latitude);
        /// <summary>
